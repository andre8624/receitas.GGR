criaCartao('classe' ,'pergunta ou o que tu quiser falar','<img class="ilustrativo" src="image copy.png" alt="ilustrativo"> <p class"preparo">a alalallalalalalallalalalla</p> <p class "ingredientes">a</p> ' )
